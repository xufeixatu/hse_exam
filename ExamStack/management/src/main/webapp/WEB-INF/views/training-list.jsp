...
<body>
			...
			<div class="row">
				...
				<div class="col-xs-10" id="right-content">
					<div class="page-header">
						<h1>
							<i class="fa fa-bar-chart-o"></i> 培训管理
						</h1>
					</div>
					<div class="page-content">
						<div class="row">
									...
									<tbody>
										<c:forEach items="${trainingList }" var="item">
											<tr>
												...
												<td><a class="delete-paper btn-sm btn-danger"> 删除</a> <a
													href="<%=list[1]%>/training/student-training-history/${item.trainingId }"
													class="btn-sm btn-info">培训进度</a> <%-- <button class="btn btn-success add-section-btn btn-sm" data-id="${item.trainingId }">添加章节</button> --%>
												</td>
											</tr>
							...
							<div class="col-xs-6" id="section-content"></div>
							<div class="col-xs-6">
								<button class="btn btn-sm btn-info add-section-btn"
									style="display: none;">新增章节</button>
							</div>
							...
							<div class="modal-dialog">
								<div class="modal-content">
										...
										<form id="section-add-form" style="margin-top: 40px;"
											...
											<div class="form-line form-group-id" style="display: none;">
												...
												<input type="text" class="df-input-narrow"
													id="training-add-id" value="" disabled="disabled">
											...
											<div class="form-line form-group" style="display: block;">
												...
												<input type="text" class="df-input-narrow"
													id="training-name" value="默认分组" disabled="disabled">
												<span class="form-message"></span> <br>
											</div>
											<div class="form-line form-group add-section-name"
												style="display: block;">
												<span class="form-label"><span class="warning-label">*</span>章节名称：</span>
												<input type="text" class="df-input-narrow" id="section-name"
													value=""> <span class="form-message"></span> <br>
											</div>
											<div class="form-line form-group add-section-desc"
												style="display: block;">
									...
									<div class="modal-footer">
										...
										<button id="add-section-btn" type="button"
	...
	<script type="text/javascript"
		src="resources/js/training-file-upload.js"></script>
	<script type="text/javascript"
		src="resources/js/add-training-section.js"></script>
	<script>
			$(function() {
