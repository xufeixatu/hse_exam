...
<body>
			...
			<div class="row">
				...
				<div class="col-xs-10" id="right-content"> --%>
					<div class="page-header">
						<h1>
							<i class="fa fa-bar-chart-o"></i> 专业题库
						</h1>
					</div>
											...
											<td><c:choose>
													<c:when test="${item.removeable }">
														<span class="delete-btn btn-sm btn-danger"
															data-id="${item.fieldId }"><i
															class="ace-icon fa fa-trash-o"></i></span>
													</c:when>
													<c:otherwise>
														<span class="btn-sm" data-id="${item.fieldId }"
															disabled="disabled"><i class="ace-icon fa fa-ban"></i></span>
													</c:otherwise>
												</c:choose></td>
										</tr>
									</c:forEach>
	...
	<footer>
		...
		<div class="modal fade" id="add-field-modal" tabindex="-1"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="field-add-form" style="margin-top: 40px;"
							action="admin/common/field-add">
