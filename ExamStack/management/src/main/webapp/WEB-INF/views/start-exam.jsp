		...
		<div class="container">
			<nav class="collapse navbar-collapse bs-navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="start-exam"><i
							class="fa fa-edit"></i>试题练习</a></li>
					...
					<div class="select-test col-xs-6">
						<div style="height: 100px;">
							...
							<div class="select-test-content">
								...
								<div class="modal fade levelup-practice-modal" tabindex="-1"
														...
														<li>
															<div class="knowledge-title">
																<i class="fa fa-chevron-up"> </i><i
																	class="fa fa-chevron-down" style="display: none;">
																</i> <span class="knowledge-title-name">${item.key}</span>
															</div>
															...
															<ul class="question-list-knowledge"
																...
																<c:forEach items="${item.value }" var="tp">
																	<li>${tp.questionTypeName }[共<span
																		class="question-number">${tp.amount } </span>题] [已做<span
																		class="question-number-2">${tp.rightTimes + tp.wrongTimes }
																	</span> 题] <a
																		href="student/practice-improve/${tp.questionPointId }/${tp.questionTypeId }"
					...
					<div class="select-test col-xs-6">
						<div style="height: 100px;">
							...
							<div class="select-test-content">
								...
								<a class="btn btn-primary" data-toggle="modal"
									data-target=".incorrect-modal"><i class="fa fa-arrow-right"></i>参加练习</a>
								<div class="modal fade incorrect-modal" tabindex="-1"
									role="dialog" aria-labelledby="myLargeModalLabel"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
												...
												<ul>
													<c:forEach items="${wrongKnowledgeMap }" var="item">
														<li><span class="point-name"> ${item.key }</span> [共<span
															class="question-number-3"><c:forEach
																	items="${item.value }" var="v">${v.value }</c:forEach>
														</span>题] <a
															href="student/practice-incorrect/<c:forEach items="${item.value }" var="k">${k.key }</c:forEach>"
															class="btn btn-success btn-sm join-practice-btn">参加练习</a>
														</li>
													</c:forEach>
					...
					<div class="select-test col-xs-6">
						<div style="height: 100px;">
							...
							<div class="select-test-content">
								...
								<p>根据你对考点的掌握程度智能出题，提升综合能力</p>
								<a class="btn btn-primary" href="student/practice-test"><i
									class="fa fa-arrow-right"></i>参加练习</a>
							</div>
							<!--//content-->
					...
					<div class="select-test col-xs-6">
						<div style="height: 100px;">
							...
							<div class="select-test-content">
								...
								<div class="modal fade practice-exampaper-modal" tabindex="-1"
									role="dialog" aria-labelledby="myLargeModalLabel"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<ul>
													<c:forEach items="${practicepaper}" var="item">
														<li><a href="student/examing/${item.id}">${item.name}</a>
														</li>
													</c:forEach>
												</ul>
											</div>
					...
					<div class="select-test col-xs-6">
						<div style="height: 100px;">
							...
							<div class="select-test-content">
								...
								<p>随机组成试卷参加考试</p>
								<a class="btn btn-primary" data-toggle="modal"
									data-target=".history-exampaper-modal" disabled="disabled"><i
									class="fa fa-arrow-right"></i>即将开放</a>
								<div class="modal fade history-exampaper-modal" tabindex="-1"
									role="dialog" aria-labelledby="myLargeModalLabel"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
					...
					<div class="select-test col-xs-6">
						<div style="height: 100px;">
							...
							<div class="select-test-content">
								...
								<a class="btn btn-primary" data-toggle="modal"
									data-target=".expert-exampaper-modal" disabled="disabled"><i
									class="fa fa-arrow-right"></i>即将开放</a>
								<div class="modal fade expert-exampaper-modal" tabindex="-1"
									role="dialog" aria-labelledby="myLargeModalLabel"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
