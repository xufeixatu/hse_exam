...
<body>
			...
			<div class="row">
				...
				<div class="col-xs-10" id="right-content">
					<div class="page-header">
						<h1>
							<i class="fa fa-file-text-o"></i> 发布培训
						</h1>
					</div>
					<div class="page-content">
						<form id="form-training-add">
							...
							<div class="form-line add-update-training-type"
								style="display: none;">
								<span class="form-label"><span class="warning-label">*</span>私有培训：</span>
								<input id="training-type" type="checkbox"
									class="df-input-narrow" checked="checked"> <span
							...
							<div class="form-line form-training-duration ">
								...
								<input id="training-exp-date" type="text"
									class="df-input-narrow"> <span class="form-message"></span>
							</div>

							<div class="form-line">
								<input value="确认发布" type="button" id="training-add-btn"
									class="df-submit btn-info btn">
							</div>
						</form>
	...
	<script type="text/javascript"
		src="resources/js/jquery.ui.datepicker-zh-TW.js"></script>
	<script type="text/javascript">
			$(function(){
