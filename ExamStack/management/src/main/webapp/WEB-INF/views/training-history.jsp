...
<body>
	...
	<div>
			...
			<div class="row">
				...
				<div class="col-xs-9">
					<div class="page-header">
						<h1>
							<i class="fa fa-bar-chart-o"></i> 培训进度
						</h1>
					</div>
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<input type="hidden" id="training-id-hidden"
									value="${trainingId }">
										...
										<tbody>
											<c:forEach items="${userTrainingList }" var="item">
												<tr>
													...
													<td>
														<div>
															<c:forEach items="${processMap[item.userId] }"
																var="processItem">
																<c:choose>
		...
		<script type="text/javascript"
			src="resources/js/training-process-list.js"></script>
</body>
</html>