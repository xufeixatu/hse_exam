...
<%-- 	<div class="navbar bs-docs-nav" role="banner">
								...
								<tbody>
									<c:forEach items="${depList }" var="item">
										<tr>
											...
											<td>${item.depName }</td>
											<td>${item.memo }</td>
											<td><span class="delete-btn btn-sm btn-danger"
												data-id="${item.depId }"><i
													class="ace-icon fa fa-trash-o"></i></span></td>
										</tr>
									</c:forEach>
	...
	<footer>
		...
		<div class="modal fade" id="add-dep-modal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="dep-add-form" style="margin-top: 40px;"
							action="admin/common/dep-add">
