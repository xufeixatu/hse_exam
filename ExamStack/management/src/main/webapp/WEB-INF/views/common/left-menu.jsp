...
<ul class="nav default-sidenav">
	...
	<c:forEach items="${leftMenuList }" var="leftMenuListItem">
		<c:if
			test="${leftMenuListItem.visiable ||leftMenuListItem.menuId eq leftMenuId}">
			<li
				<c:if test="${leftMenuListItem.menuId eq leftMenuId}">class="active"</c:if>>
				<a href="${leftMenuListItem.menuHref }"
				title="${leftMenuListItem.menuName }"><i
