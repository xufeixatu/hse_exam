...
<body>
			...
			<div class="row">
				...
				<div class="col-xs-10" id="right-content">
					<div class="page-header">
						<h1>
							<i class="fa fa-bar-chart-o"></i> 教师管理
						</h1>
					</div>
								...
								<tbody>
									...
									<c:forEach items="${userList }" var="item">
										<tr>
											...
											<td>
												<div class="r-truename">${item.trueName }</div>
												<div class="r-national-id">${item.nationalId }</div>
											</td>
											<td>
												<div class="r-phone">${item.phoneNum }</div>
												<div class="r-email">${item.email }</div>
											</td>
											...
											<td><span class="r-createtime"> <fmt:formatDate
											...
											<td><span class="r-update-btn btn-sm btn-success"
												data-id="21321" data-depid="${item.depId }">修改</span><span
												class="disable-btn btn-sm btn-danger"
												data-id="${item.userId }" data-status="${!item.enabled }">
													<c:choose>
														<c:when test="${!item.enabled }">
															启用
														</c:when>
											...
											</span> <span class="r-reset-pwd-btn btn-sm btn-warning"
												data-id="21321" data-depid="6">密码</span></td>
	...
	<footer>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="teacher-add-form" style="margin-top: 40px;"
							action="admin/add-user-ROLE_TEACHER-0">
							...
							<div class="form-line form-email" style="display: block;">
								...
								<input type="text" class="df-input-narrow" id="email-add"
									maxlength="90"> <span class="form-message"></span> <br>
							</div>
							<div class="form-line form-company" style="display: none;">
								...
								<input type="text" class="df-input-narrow" id="company-add"
									maxlength="30"> <span class="form-message"></span> <br>
							</div>
					...
					<div class="modal-footer">
						...
						<button id="add-user-btn"
							data-action="admin/add-user-ROLE_TEACHER"
							data-url="admin/user/teacher-list" data-group="0" type="button"
		...
		<div class="modal fade" id="update-teacher-modal" tabindex="-1"
			role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						<form id="teacher-update-form" style="margin-top: 40px;"
							...
							<div class="form-line form-username-u" style="display: block;">
								...
								<input type="text" class="df-input-narrow" id="name-update"
									disabled="disabled"> <span class="form-message"></span>
								<br>
							</div>
							<div class="form-line form-password-u" style="display: none;">
								<span class="form-label"><span class="warning-label">*</span>密码：</span>
								<input type="text" class="df-input-narrow" id="password-update"
									maxlength="20"> <span class="form-message"></span> <br>
							</div>
