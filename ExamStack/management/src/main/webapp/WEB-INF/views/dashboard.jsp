...
<link href='resources/fullcalendar-2.1.1/fullcalendar.css'
	rel='stylesheet' />
<link href='resources/fullcalendar-2.1.1/fullcalendar.print.css'
...
<%-- 
			...
			<div class="row">
				<!-- <div class="col-xs-2" id="left-menu">
					<ul class="nav default-sidenav">
						<li><a href="admin/question/question-add" title="添加试题"><i
								class="fa fa-plus">&nbsp;</i><span class="left-menu-item-name">
									添加试题</span></a></li>
						<li><a href="admin/exampaper/exampaper-add" title="创建新试卷"><i
								class="fa fa-leaf">&nbsp;</i><span class="left-menu-item-name">
									创建新试卷</span></a>
						<li><a href="admin/exam/exam-add" title="发布考试"><i
								class="fa fa-plus-square-o">&nbsp;</i><span
								class="left-menu-item-name"> 发布考试</span></a></li>
						<li><a href="admin/exam/model-test-add" title="发布模拟考试"><i
								class="fa fa-flag">&nbsp;</i><span class="left-menu-item-name">
									发布模拟考试</span></a></li>
					</ul> 
				</div> -->
				...
				<div class="col-xs-10" id="right-content">
					...
					<div class="page-content">
						<div class="bs-example bs-example-bg-classes"
							data-example-id="contextual-backgrounds-helpers">
							<p class="bg-success">
								<i class="ace-icon fa fa-check green"></i>

								欢迎使用HSE后台管理系统，您可以在此页面快速查看您系统的状态。
							</p>
							...
							<div class="row" style="margin-top: 20px;">
								<div class="col-xs-7">
									...
									<div class="widget-box transparent">
										<div class="widget-header widget-header-flat">
											<h4 class="widget-title lighter">
												<i class="ace-icon fa fa-star orange"></i> 需要审核
											</h4>
									...
									<div class="widget-box transparent">
										<div class="widget-header widget-header-flat">
											<h4 class="widget-title lighter">
												<i class="ace-icon fa fa-rss orange"></i> 需要阅卷
											</h4>
								...
								<div class="col-xs-5">
									<div class="widget-box">
										<div class="widget-header widget-header-flat">
											<h4 class="widget-title lighter">
												<i class="ace-icon fa fa-signal orange"></i> Popular Domains
											</h4>
	...
	<script type="text/javascript"
		src="resources/fullcalendar-2.1.1/lib/moment.min.js"></script>
	<script type="text/javascript"
		src="resources/fullcalendar-2.1.1/fullcalendar.min.js"></script>
	<script type="text/javascript"
		src="resources/fullcalendar-2.1.1/lang-all.js"></script>
