...
<body>
 ...
 --%>
			...
			<div class="row">
				...
				<div class="col-xs-10" id="right-content">
					<div class="page-header">
						<h1>
							<i class="fa fa-bar-chart-o"></i> 知识分类管理
						</h1>
					</div> --%>
										...
										<tr>
											...
											<td><c:choose>
													<c:when test="${item.removeable }">
														<span class="delete-btn btn-sm btn-danger"
															data-id="${item.pointId }"><i
															class="ace-icon fa fa-trash-o"></i></span>
													</c:when>
													<c:otherwise>
														<span class="btn-sm" data-id="${item.pointId }"
															disabled="disabled" title="无法删除"><i
	...
	<div class="modal fade" id="add-knowledge-modal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="knowledge-add-form" style="margin-top: 40px;"
						action="admin/common/point-add">
						...
						<div class="form-line form-knowledge-name" style="display: block;">
							...
							<input type="text" class="df-input-narrow" id="name"> <span
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">
						关闭窗口</button>
					<button id="add-knowledge-btn" type="button"
