							...
							<c:choose>
								...
								<c:otherwise>
									...
									<li class="news-list-item clearfix">
										...
										<div class="news-list-thumbnail">
											<img src="#resources/images/index/index2.jpg">
										</div>
										<div class="news-list-content">
											<div class="news-list-title">
												${newsList[1].title }
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="copy">
							<p>
								HSE Copyright © <a href="#" target="_blank">HSE</a> - <a href="." target="_blank">主页</a> | <a href="#" target="_blank">关于我们</a> | <a href="#" target="_blank">FAQ</a> | <a href="#" target="_blank">联系我们</a>
							</p>
						</div>
					</div>
				</div>
